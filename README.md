...
It shares some components with the code of Grace Avecilla (Avecilla et. al, 2022), mostly regarding network's training.

To run the inference and see its results:

1. install sbi using pip - 'pip install sbi'
2. Create a folder named "presimulated_data", and generate 100k simulations using generate_presimulated_data_initial_beneficial.py:
